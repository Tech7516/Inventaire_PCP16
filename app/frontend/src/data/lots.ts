...
// Lot C — POM has different L1G and L1M from Lot A
subEntitySections["pom-c"] = [
  {
    id: "pomc-1g",
    title: "1ère ligne — Pochette de gauche",
    items: [
      { id: "pomc-001", name: "BAVU Adulte", expectedQuantity: 1 },
      { id: "pomc-002", name: "Masque T4", expectedQuantity: 1 },
      { id: "pomc-003", name: "Masque T5", expectedQuantity: 1 },
    ],
  },
  {
    id: "pomc-1m",
    title: "1ère ligne — Pochette du milieu",
    items: [
      { id: "pomc-004", name: "BAVU Pédiatrique", expectedQuantity: 1 },
      { id: "pomc-005", name: "BAVU Nourrisson", expectedQuantity: 1 },
      { id: "pomc-006", name: "Masque T0", expectedQuantity: 1 },
      { id: "pomc-007", name: "Masque T1", expectedQuantity: 1 },
      { id: "pomc-008", name: "Masque T2", expectedQuantity: 1 },
    ],
  },
  {
    id: "pomc-1d",
    title: "1ère ligne — Pochette de droite",
    items: [
      { id: "pomc-009", name: "Jeu de canule", expectedQuantity: 1 },
      { id: "pomc-010", name: "Recharge AMS", expectedQuantity: 1 },
    ],
  },
  {
    id: "pomc-2g",
    title: "2ème ligne — Pochette de gauche",
    items: [
      { id: "pomc-011", name: "MHC adulte", expectedQuantity: 4 },
      { id: "pomc-012", name: "MMC adulte", expectedQuantity: 4 },
      { id: "pomc-013", name: "Lunettes O2", expectedQuantity: 3 },
    ],
  },
  {
    id: "pomc-2m",
    title: "2ème ligne — Pochette du milieu",
    items: [
      { id: "pomc-014", name: "MHC pédiatrique", expectedQuantity: 3 },
      { id: "pomc-015", name: "MMC pédiatrique", expectedQuantity: 3 },
    ],
  },
  {
    id: "pomc-2d",
    title: "2ème ligne — Pochette de droite",
    items: [
      { id: "pomc-016", name: "Pansement absorbant", expectedQuantity: 5 },
      { id: "pomc-017", name: "CHU", expectedQuantity: 1 },
      { id: "pomc-018", name: "GISH", expectedQuantity: 1 },
      { id: "pomc-019", name: "Pansement israélien", expectedQuantity: 2 },
      { id: "pomc-020", name: "Garrot tourniquet", expectedQuantity: 2 },
    ],
  },
  {
    id: "pomc-3g",
    title: "3ème ligne — Pochette de gauche",
    items: [
      { id: "pomc-021", name: "Tensiomètre manuel", expectedQuantity: 1 },
      { id: "pomc-022", name: "Jeu de 3 brassards", expectedQuantity: 1 },
      { id: "pomc-023", name: "Stéthoscope", expectedQuantity: 1 },
    ],
  },
  {
    id: "pomc-3m",
    title: "3ème ligne — Pochette du milieu",
    items: [
      { id: "pomc-024", name: "Thermomètre tympanique", expectedQuantity: 1 },
      { id: "pomc-025", name: "Boîte d'embouts tympaniques", expectedQuantity: 2 },
      { id: "pomc-026", name: "Oxymètre", expectedQuantity: 1 },
      { id: "pomc-027", name: "Tensiomètre électronique", expectedQuantity: 1 },
    ],
  },
  {
    id: "pomc-3d",
    title: "3ème ligne — Pochette de droite",
    items: [
      { id: "pomc-028", name: "Haricot réutilisable", expectedQuantity: 2 },
      { id: "pomc-029", name: "Jesco", expectedQuantity: 1 },
      { id: "pomc-030", name: "Pince à écharde", expectedQuantity: 1 },
      { id: "pomc-031", name: "Tire-tique", expectedQuantity: 1 },
      { id: "pomc-032", name: "OPTC", expectedQuantity: 1 },
      { id: "pomc-033", name: "Sparadrap", expectedQuantity: 2 },
      { id: "pomc-034", name: "Glucomètre", expectedQuantity: 1 },
      { id: "pomc-035", name: "Réserve de bandelettes", expectedQuantity: 2 },
      { id: "pomc-036", name: "Auto-piqueur", expectedQuantity: 30 },
    ],
  },
  {
    id: "pomc-4g",
    title: "4ème ligne — Pochette de gauche",
    items: [
      { id: "pomc-037", name: "Écharpe", expectedQuantity: 5 },
      { id: "pomc-038", name: "Poche de froid", expectedQuantity: 5 },
      { id: "pomc-039", name: "Détergent de surface en spray", expectedQuantity: 1 },
      { id: "pomc-040", name: "Paquet de lingettes nettoyantes", expectedQuantity: 1 },
    ],
  },
  {
    id: "pomc-4m",
    title: "4ème ligne — Pochette du milieu",
    items: [
      { id: "pomc-041", name: "Sérum physiologique 5ml", expectedQuantity: 30 },
    ],
  },
  {
    id: "pomc-4d",
    title: "4ème ligne — Pochette de droite",
    items: [
      { id: "pomc-042", name: "Lot de 2 compresses stériles", expectedQuantity: 25 },
      { id: "pomc-043", name: "Boîte de compresses non stériles", expectedQuantity: 1 },
      { id: "pomc-044", name: "Pansement 20x10cm", expectedQuantity: 5 },
      { id: "pomc-045", name: "Pansement 10x8cm", expectedQuantity: 5 },
      { id: "pomc-046", name: "Pansement 7,5x5cm", expectedQuantity: 5 },
      { id: "pomc-047", name: "Boîte de petits pansements", expectedQuantity: 1 },
      { id: "pomc-048", name: "SHA", expectedQuantity: 1 },
    ],
  },
  {
    id: "pomc-5g",
    title: "5ème ligne — Pochette de gauche",
    items: [
      { id: "pomc-049", name: "Bande 10x4cm", expectedQuantity: 5 },
      { id: "pomc-050", name: "Bande 6x4cm", expectedQuantity: 5 },
      { id: "pomc-051", name: "Filet tubulaire de différentes tailles", expectedQuantity: 3 },
      { id: "pomc-052", name: "Bande cohésive", expectedQuantity: 3 },
    ],
  },
  {
    id: "pomc-5m",
    title: "5ème ligne — Pochette du milieu",
    items: [
      { id: "pomc-053", name: "Compresse gel d'eau 20x20cm", expectedQuantity: 1 },
      { id: "pomc-054", name: "Compresse gel d'eau 10x10cm", expectedQuantity: 2 },
      { id: "pomc-055", name: "Champ stérile 10x10cm", expectedQuantity: 2 },
      { id: "pomc-056", name: "Couverture de survie", expectedQuantity: 10 },
      { id: "pomc-057", name: "Gobelet", expectedQuantity: 20 },
      { id: "pomc-058", name: "Sucre + touillette", expectedQuantity: 20 },
    ],
  },
  {
    id: "pomc-5d",
    title: "5ème ligne — Pochette de droite",
    items: [
      { id: "pomc-059", name: "Sac vomitoire", expectedQuantity: 15 },
      { id: "pomc-060", name: "Paire de lunettes de protection", expectedQuantity: 4 },
    ],
  },
];
