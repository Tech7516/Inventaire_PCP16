...
export const subEntitySections: Record<string, ConsumableSection[]> = {
  ...
  "materiel-comp": [
    {
      id: "mc-bureau",
      title: "Dans le bureau",
      items: [
        { id: "mc-001", name: "T7", expectedQuantity: 1 },
        { id: "mc-002", name: "DSA", expectedQuantity: 1 },
        { id: "mc-003", name: "Radio", expectedQuantity: 2 },
        { id: "mc-004", name: "Chargeur de radio", expectedQuantity: 1 },
        { id: "mc-005", name: "AMS", expectedQuantity: 1 },
        { id: "mc-006", name: "Lampe torche", expectedQuantity: 1 },
        { id: "mc-007", name: "Tablette", expectedQuantity: 1 },
      ],
    },
    {
      id: "mc-optionnel",
      ...
      items: [
        { id: "mc-008", name: "Tente + murs + poids + flamme + pieds", expectedQuantity: 1 },
        { id: "mc-009", name: "Table (avec tabourets)", expectedQuantity: 1 },
        { id: "mc-010", name: "Multiprise", expectedQuantity: 1 },
        { id: "mc-011", name: "Chauffage", expectedQuantity: 1 },
        { id: "mc-012", name: "Péli", expectedQuantity: 1 },
      ],
    },
    {
      id: "mc-local",
      title: "À prendre en plus dans le local en bas",
      items: [
        { id: "mc-013", name: "Sac de soin", expectedQuantity: 1 },
        { id: "mc-014", name: "Sac d'O2", expectedQuantity: 1 },
        { id: "mc-015", name: "Chaise", expectedQuantity: 1 },
        { id: "mc-016", name: "Grand POM", expectedQuantity: 1 },
        { id: "mc-017", name: "Caisse LOT A (1/2)", expectedQuantity: 1 },
        { id: "mc-018", name: "Caisse LOT A (2/2)", expectedQuantity: 1 },
        { id: "mc-019", name: "Lit pico / snoog / brancard pliant", expectedQuantity: 2 },
        { id: "mc-020", name: "Bouteille d'O2", expectedQuantity: 1 },
        { id: "mc-021", name: "Plan dur", expectedQuantity: 1 },
        { id: "mc-022", name: "Brancard cuillère", expectedQuantity: 1 },
        { id: "mc-023", name: "Matelas immobilisateur à dépression + pompe", expectedQuantity: 1 },
        { id: "mc-024", name: "Couverture de survie (avec MID)", expectedQuantity: 1 },
        { id: "mc-025", name: "Drap UU (avec MID)", expectedQuantity: 1 },
      ],
    },
    {
      id: "mc-admin",
      title: "Administratif LOT A",
      items: [
        { id: "mc-026", name: "Main courante autocopiante et règle", expectedQuantity: 1 },
        { id: "mc-027", name: "Bloc de fiches bilans", expectedQuantity: 1 },
        { id: "mc-028", name: "Cahier DSA PCPS", expectedQuantity: 1 },
        { id: "mc-029", name: "Cahier de suivi de victimes", expectedQuantity: 1 },
        { id: "mc-030", name: "Inventaire du lot A et du lot B", expectedQuantity: 1 },
      ],
    },
    {
      id: "mc-reserve",
      ...
      items: [
        { id: "mc-031", name: "Rouleau de sparadrap", expectedQuantity: 2 },
        { id: "mc-032", name: "Protection auditive", expectedQuantity: 20 },
        { id: "mc-033", name: "Bande élastique", expectedQuantity: 3 },
        { id: "mc-034", name: "Bande S", expectedQuantity: 5 },
        { id: "mc-035", name: "Bande L", expectedQuantity: 5 },
        { id: "mc-036", name: "Sérum physiologique", expectedQuantity: 20 },
        { id: "mc-037", name: "Boîte de petits pansements", expectedQuantity: 1 },
      ],
    },
    {
      id: "mc-traumato",
      ...
      items: [
        { id: "mc-038", name: "Poche de froid instantanée", expectedQuantity: 10 },
        { id: "mc-039", name: "Couverture de survie", expectedQuantity: 10 },
        { id: "mc-040", name: "Écharpe", expectedQuantity: 5 },
      ],
    },
    {
      id: "mc-vrac",
      title: "En vrac",
      items: [
        { id: "mc-041", name: "Boîte de masques FFP2", expectedQuantity: 1 },
        { id: "mc-042", name: "Boîte de masques chirurgicaux", expectedQuantity: 1 },
        { id: "mc-043", name: "Drap UU", expectedQuantity: 10 },
        { id: "mc-044", name: "Eau (litres)", expectedQuantity: 6 },
        { id: "mc-045", name: "Boîte de gants non stériles", expectedQuantity: 8 },
        { id: "mc-046", name: "Rouleau DASRI", expectedQuantity: 2 },
        { id: "mc-047", name: "Rouleau DAOM", expectedQuantity: 2 },
        { id: "mc-048", name: "SHA", expectedQuantity: 1 },
        { id: "mc-049", name: "Couverture bactériostatique", expectedQuantity: 2 },
        { id: "mc-050", name: "Paquet de lingettes de nettoyage", expectedQuantity: 1 },
        { id: "mc-051", name: "Détergent surfaces hautes en spray", expectedQuantity: 1 },
        { id: "mc-052", name: "Savon liquide", expectedQuantity: 1 },
        { id: "mc-053", name: "Lot de papier absorbant", expectedQuantity: 1 },
        { id: "mc-054", name: "Paire de gants de déblai", expectedQuantity: 2 },
        { id: "mc-055", name: "Rouleau de rubalise", expectedQuantity: 1 },
        { id: "mc-056", name: "Cardio-pompe", expectedQuantity: 1 },
      ],
    },
  ],
};